<script>
	import EmailSignUp from '$lib/EmailSignUp.svelte';
	import EarlyAccess from '$lib/footer/EarlyAccess.svelte';
</script>
...
<section>
	...
	<div class="pt-24">
		<div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
			...
			<div class="w-full md:w-3/5 py-6 text-center">
				<img class="w-full z-50" src="undraw-profile-feedback.png" alt="profile feedback" />
			</div>
		</div>
	</div>
	...
	<section class="bg-white py-8">
		<div class="container max-w-5xl mx-auto m-8">
			<!-- <h2 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Title</h2> -->
